...
export function FloatingWhatsApp() {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 group">
            ...
            <div className="bg-white text-stone-800 px-4 py-2 rounded-xl shadow-xl font-bold text-sm tracking-wide transform origin-right scale-0 group-hover:scale-100 transition-all duration-300 pointer-events-none whitespace-nowrap border border-stone-100">
                Chat with us!
            </div>
